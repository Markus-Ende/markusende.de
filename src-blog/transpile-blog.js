...
const outputMetadataJson = outputDirectory + '/blog-metadata.generated.json';
const outputHtmlTemplate = outputDirectory + '/blog-data.generated.html';
const outputBlogEntryIdEnum = outputDirectory + '/blog-entry-id.enum.generated.ts';
const blogMetadata = [];
